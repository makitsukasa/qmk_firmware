...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	[0] = KEYMAP( \
		...
		// +--------+--------+--------+--------+--------------+--------+--------------+  +--------------+--------+--------------+--------+--------+--------+--------+
			KC_LSFT, KC_Z,    KC_X,    KC_C,    KC_V,          KC_B,    KC_N,             JP_RBRC,       KC_N,    KC_M,          KC_COMM, KC_DOT,  KC_SLSH, MO(1),
		// +--------+--------+--------+--------+--------------+--------+--------------+  +--------------+--------+--------------+--------+--------+--------+--------+
			KC_LCTL, KC_LGUI, KC_LALT, KC_MHEN, LT(2, KC_SPC), KC_SPC,  LT(4, KC_SPC),    LT(4, KC_SPC), KC_SPC,  LT(2, KC_SPC), KC_HENK, KC_F2,   KC_APP,  KC_RCTL
		// +--------+--------+--------+--------+--------------+--------+--------------+  +--------------+--------+--------------+--------+--------+--------+--------+
	),
	// shift
	[1] = KEYMAP( \
		// +-----------+-----------+-----------+-----------+-----------+-----------+-----------+  +-----------+-----------+-----------+-----------+-----------+-----------+-----------+
			_______,    LSFT(KC_Q), LSFT(KC_W), LSFT(KC_E), LSFT(KC_R), LSFT(KC_T), LSFT(KC_Y),    _______,    RSFT(KC_Y), RSFT(KC_U), RSFT(KC_I), RSFT(KC_O), RSFT(KC_P), _______,
		// +-----------+-----------+-----------+-----------+-----------+-----------+-----------+  +-----------+-----------+-----------+-----------+-----------+-----------+-----------+
		...
		// +-----------+-----------+-----------+-----------+-----------+-----------+-----------+  +-----------+-----------+-----------+-----------+-----------+-----------+-----------+
			_______,    LSFT(KC_Z), LSFT(KC_X), LSFT(KC_C), LSFT(KC_V), LSFT(KC_B), LSFT(KC_N),    JP_RBRC,    RSFT(KC_N), RSFT(KC_M), JP_LT,      JP_GT,      JP_QUES,    _______,
		// +-----------+-----------+-----------+-----------+-----------+-----------+-----------+  +-----------+-----------+-----------+-----------+-----------+-----------+-----------+
			_______,    _______,    _______,    LT(4, KC_SPC), _______, _______,    _______,       _______,    _______,    LT(4, KC_SPC), _______, _______,    _______,    _______
		// +-----------+-----------+-----------+-----------+-----------+-----------+-----------+  +-----------+-----------+-----------+-----------+-----------+-----------+-----------+
	),
	// nums and arrows
	[2] = KEYMAP( \
		...
		// +--------+--------+--------+--------+--------+--------+--------------+  +--------------+--------+--------+--------+--------+--------+--------+
			MO(3),   KC_6,    KC_7,    KC_8,    KC_9,    KC_0,    JP_RPRN,          _______,       KC_HOME, KC_PGDN, KC_PGUP, KC_END,  _______, MO(3),
		// +--------+--------+--------+--------+--------+--------+--------------+  +--------------+--------+--------+--------+--------+--------+--------+
	...
	[3] = KEYMAP( \
		// +--------+--------+--------+--------+--------------+--------+--------+  +--------+--------+--------------+--------+--------+--------+--------+
			KC_ESC,  JP_TILD, JP_UNDS, JP_PLUS, JP_DQT,       JP_PIPE,  _______,    _______, XXXXXXX, KC_F6,         KC_F7,   KC_F8,   KC_F10,  _______,
		// +--------+--------+--------+--------+--------------+--------+--------+  +--------+--------+--------------+--------+--------+--------+--------+
			_______, JP_EXLM, JP_AT,   JP_HASH, JP_DLR,        JP_PERC, _______,    JP_LCBR, _______, _______,       _______, _______, JP_COLN, _______,
		// +--------+--------+--------+--------+--------------+--------+--------+  +--------+--------+--------------+--------+--------+--------+--------+
			_______, JP_CIRC, JP_AMPR, JP_ASTR, JP_LPRN,       JP_RPRN, _______,    JP_RCBR, JP_LCBR, JP_RCBR,       KC_LT,   KC_GT,   KC_QUES, _______,
		// +--------+--------+--------+--------+--------------+--------+--------+  +--------+--------+--------------+--------+--------+--------+--------+
			_______, _______, _______, _______, LT(4, KC_SPC), _______, _______,    _______, _______, LT(4, KC_SPC), _______, KC_PSCR, _______, _______
		// +--------+--------+--------+--------+--------------+--------+--------+  +--------+--------+--------------+--------+--------+--------+--------+
	),
	// function keys
	[4] = KEYMAP( \
