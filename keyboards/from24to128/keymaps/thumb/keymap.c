...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	[0] = KEYMAP( \
		...
		// +--------+--------+--------+--------+--------+--------+--------+  +--------+--------+--------+--------+--------+--------+--------+
			XXXXXXX, KC_LGUI, KC_LALT, KC_MHEN, LTMH(2), SandS_1, CandS,      CandS,   SandS_1, LTHE(2), KC_HENK, KC_F2,   KC_APP,  XXXXXXX
		// +--------+--------+--------+--------+--------+--------+--------+  +--------+--------+--------+--------+--------+--------+--------+
	),
	// shift
	[1] = KEYMAP( \
	...
	[2] = KEYMAP( \
		...
		// +--------+--------+--------+--------+--------+--------+--------+  +--------+--------+--------+--------+--------+--------+--------+
			_______, KC_1,    KC_2,    KC_3,    KC_4,    KC_5,    _______,    _______, KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT, JP_COLN, _______,
		// +--------+--------+--------+--------+--------+--------+--------+  +--------+--------+--------+--------+--------+--------+--------+
